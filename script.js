...
function updateTextToEnglish() {
    ...
    document.getElementById("experience").textContent = "10 years of experience in the hospitality industry as a waiter, bar manager, and floor manager. During this time, I developed my skills in conflict resolution and in organizing a well-coordinated and united team. I was also responsible for procuring raw materials as well as managing both the financial and physical resources of the company. Speed, attention to detail, and learning protocols are some of the skills I honed while working in this profession."
